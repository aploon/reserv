                        ...
                        {{-- <x-guest-layout>
                            ...
                            <form class="form" method="POST" id="kt_login_signup_form" action="{{ route('register') }}">
                                ...
                                <div class="form-group">
                                    ...
                                    type="text" placeholder="Nom d'utilisateur" name="name" required autofocus />
                                </div>
                                <!--end::Form group-->
                                <!--begin::Form group-->
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <input class="form-control form-control-solid h-auto py-6 px-6 rounded-lg font-size-h6"
                                        type="password" placeholder="Mot de passe" name="password" autocomplete="current-password" />
                                </div>
                                <!--end::Form group-->
                                ...
                                <div class="form-group">
                                    <input class="form-control form-control-solid h-auto py-6 px-6 rounded-lg font-size-h6"
                                        type="password" placeholder="Confirmer votre mot de passe" name="password_confirmation"
