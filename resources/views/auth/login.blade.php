                    ...
                    <div class="login-form login-signin">
                        ...
                        <form class="form" method="POST" id="kt_login_signin_form"
                            ...
                            <div class="pb-13 pt-lg-0 pt-5">
                                <h3 class="font-weight-bolder text-dark font-size-h4 font-size-h1-lg">Bienvenu sur
                                    Reserv</h3>
                                <span class="text-muted font-weight-bold font-size-h4">Nouveau ici ?
                                    <a href="{{ route('register') }}" id="kt_login_signup_off"
                            ...
                            <div class="form-group">
                                <div class="d-flex justify-content-between mt-n5">
                                    ...
                                    <a href="{{ Route('password.email') }}"
                                        ...
                                        id="kt_login_forgot_off">Mot de passe oublié ?</a>
                                </div>
                            ...
                            <div class="pb-lg-0 pb-5">
                                <button type="submit" id="kt_login_signin_submit_off"
                                    class="btn btn-primary font-weight-bolder font-size-h6 px-8 py-4 my-3 mr-3 w-100">Connexion</button>
                                {{-- <button type="button"
